...
\section{実験準備}
表\ref{five:one}に実験で使用した機材および実行環境示す。
\begin{table}[H]
  \centering
...
透視投影画像上の2次元座標と世界座標の3次元座標とを対応付けることで、全方位カメラの位置と姿勢を推定した（図\ref{five:three}）。
...
\begin{figure}[H]
  \centering
  \begin{tabular}{ccc}
    \includegraphics[width=0.3\textwidth]{figures/5/wire1.png} &
    \includegraphics[width=0.3\textwidth]{figures/5/wire2.png} &
    \includegraphics[width=0.3\textwidth]{figures/5/wire3.png}
  \end{tabular}
...
\begin{figure}[H]
  \centering
  \begin{tabular}{ccc}
    \includegraphics[width=0.3\textwidth]{figures/5/4m.png}
    \includegraphics[width=0.3\textwidth]{figures/5/3m.png}
    \includegraphics[width=0.3\textwidth]{figures/5/2m.png}
  \end{tabular}
